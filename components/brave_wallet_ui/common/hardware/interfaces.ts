...
export abstract class LedgerSolanaKeyring extends HardwareKeyring {
  ...
  abstract signTransaction (path: string, rawTxBase64: string): Promise<SignHardwareTransactionOperationResult> // TODO(nvonpentz) - accept bytes not base64 encoded string
  abstract makeApp (): Promise<void>
}
