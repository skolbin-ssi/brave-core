...
#ifndef BRAVE_COMPONENTS_BRAVE_PRIVATE_NEW_TAB_UI_PREF_NAMES_H_
#define BRAVE_COMPONENTS_BRAVE_PRIVATE_NEW_TAB_UI_PREF_NAMES_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_PRIVATE_NEW_TAB_UI_PREF_NAMES_H_
